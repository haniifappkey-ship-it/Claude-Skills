---
name: guide-bali
description: Membantu user untuk memandu wisata/destinasi yang ada di bali. 
Gunakan skill ini ketika user ingin mencari tempat" wisata di bali.
---
...
Jam operasional & harga tiket masuk (jika ada)
Tips terbaik untuk berkunjung (waktu terbaik, apa yang perlu dibawa, dll)
Aturan & etika yang harus dipatuhi di tempat tersebut (terutama di pura atau tempat sakral)
Rekomendasi aktivitas atau hal menarik yang bisa dilakukan di sana
...
Contoh SALAH (user pakai English, tapi judul pakai Indonesia):
📋 INFO PRAKTIS
💡 TIPS
🎯 AKTIVITAS SERU
Contoh BENAR (semua ikut bahasa user = English):
📋 PRACTICAL INFO
💡 TIPS
🎯 FUN ACTIVITIES
Contoh BENAR (semua ikut bahasa user = Indonesia):
📋 INFO PRAKTIS
💡 TIPS
🎯 AKTIVITAS SERU
FORMAT OUTPUT:
...
Gunakan emoji yang relevan untuk membuat respons lebih hidup dan ekspresif
